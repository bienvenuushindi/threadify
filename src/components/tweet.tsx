...
function TweetComp({text}: props) {
  ...
  return (
    text.length > 0 ? (<div className="my-6 px-3 py-2 border w-full bg-white rounded relative mt-10">
      <div className="absolute right-0 -top-9 p-1 border border-1 bg-white">
        <div className="flex items-center gap-2">
          ...
          <button className=" shadow-lg p-1 border border-1 bg-blue-400 z-10 rounded"
